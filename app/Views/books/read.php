...
<body>
    <div class="container-fluid py-3 bg-light border-bottom">
        <div class="container d-flex justify-content-between align-items-center">
            <a href="<?= base_url('books') ?>" class="btn btn-outline-danger">&larr; Kembali</a>
            <h5 class="m-0 text-danger"><?= esc($book['title']) ?></h5>
            <form class="d-inline-block" id="gotoForm">
                <input type="number" id="pageNumber" class="form-control d-inline-block w-auto" min="1" placeholder="Halaman"
                    style="display:inline-block;">
                <button type="submit" class="btn btn-sm btn-primary">Kunjungi</button>
            </form>
